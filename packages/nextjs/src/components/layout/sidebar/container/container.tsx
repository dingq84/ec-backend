    ...
    <SidebarContext.Provider value={{ isFloat }}>
      ...
      >
        <button
          ...
          onClick={handleClick}
          tw="absolute left-full top-12 py-2 px-2.5 rounded-full text-blue-1 bg-white w-6 h-6 transform -translate-x-1/2 -translate-y-1/2 shadow-md border border-solid border-gray-1 hover:(bg-p1 text-b0 border-p1)"
        >
          <FontAwesomeIcon
            icon={faChevronLeft}
