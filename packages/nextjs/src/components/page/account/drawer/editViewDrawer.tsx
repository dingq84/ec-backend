  ...
  const { isLoading: updateAdminLoading, mutate: updateAdminMutate } = useNormalMutation(
    (data: IUpdateAdminInputPort) => core.admin.updateAdmin(data),
    {
      ...
      onError(error) {
        ...
        const errorData = data as Record<Partial<keyof IUpdateAdminInputPort>, 'string'> | []
        // 後端回傳的 data 為空陣列
        ...
        handleErrorTarget(
          Object.keys(errorData) as Array<Partial<Exclude<keyof IUpdateAdminInputPort, 'id'>>>
        )
